...
var WeekHeadColor = "#616D7E"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#ECE5B6"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#ECE5B6"; //Background color of Saturday.
var WeekDayColor = "#ECE5B6"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#98AFC7"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#C9C299"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
...
// Calendar prototype
function RainforestCalendar(pDate, pCtrl)
{
...
RainforestCalendar.prototype.GetMonthIndex = function (shortMonthName)
{
...
RainforestCalendar.prototype.IncYear = function () {
    if (Cal.Year <= dtToday.getFullYear()+EndYear)
	    Cal.Year += 1;
};

RainforestCalendar.prototype.DecYear = function () {
    if (Cal.Year > StartYear)
	    Cal.Year -= 1;
};

RainforestCalendar.prototype.IncMonth = function() {
    if (Cal.Year <= dtToday.getFullYear() + EndYear) {
        Cal.Month += 1;
        if (Cal.Month >= 12) {
            Cal.Month = 0;
...
RainforestCalendar.prototype.DecMonth = function() {
    if (Cal.Year >= StartYear) {
        Cal.Month -= 1;
        if (Cal.Month < 0) {
            Cal.Month = 11;
...
RainforestCalendar.prototype.SwitchMth = function (intMth)
{
	Cal.Month = parseInt(intMth, 10);
};

RainforestCalendar.prototype.SwitchYear = function (intYear)
{
	Cal.Year = parseInt(intYear, 10);
};

RainforestCalendar.prototype.SetHour = function (intHour)
{
  intHour = trim(intHour);
	var MaxHour,
	MinHour,
	...
	{
		if ((TimeMode === 12) && (Cal.AMorPM === "PM" || Cal.AMorPM === "pm"))
		{
		...
		else if ((TimeMode === 12) && (Cal.AMorPM === "AM" || Cal.AMorPM === "am"))
		{
			if (intHour === 12)
			{
				intHour -= 12;
...
RainforestCalendar.prototype.SetMinute = function (intMin)
{
	var MaxMin = 59,
	MinMin = 0,
...
RainforestCalendar.prototype.SetSecond = function (intSec)
{
	var MaxSec = 59,
	MinSec = 0,
...
RainforestCalendar.prototype.SetAmPm = function (pvalue)
{
	this.AMorPM = pvalue;
	if (pvalue === "PM")
	{
...
RainforestCalendar.prototype.getShowHour = function ()
{
	var finalHour;
...
RainforestCalendar.prototype.getShowAMorPM = function ()
{
	return this.AMorPM;
};

RainforestCalendar.prototype.GetMonthName = function (IsLong)
{
...
RainforestCalendar.prototype.GetMonDays = function() { //Get number of days in a month
...
RainforestCalendar.prototype.IsLeapYear = function ()
{
	if ((this.Year % 4) === 0)
	{
...
RainforestCalendar.prototype.FormatDate = function (pDate)
{
...
function RenderCssCal(bNewCal)
{
  ...
  // WR: modify to have a span id, and then to set the border/padding of tds inside this span:
  // since the project's css was interfering with the display of the calendar
  winCalData = "<style type='text/css'>#rainforestCal td {border:0;padding:0};</style>";
	winCalData += "<span id='rainforestCal' style='cursor:auto;'>";
...
function NewCssCal(pCtrl, pFormat, pScroller, pShowTime, pTimeMode, pShowSeconds)
{
	...
	dtToday = new Date();
	Cal = new RainforestCalendar(dtToday);

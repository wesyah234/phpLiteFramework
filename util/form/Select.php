...
class PLF_Select extends PLF_Element {
  var $values;
  var $onChange;
  ...
  function render($tabIndex) {
    ...
    $toReturn = ' <select  '.$this->getDisabledAttribute().' '.$onChangeText.' tabindex="'.$tabIndex.'" name="'.$this->getName().'" id="'.$this->getName().'" '.$this->attribute.' >';

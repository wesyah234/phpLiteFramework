...
class PLF_SingleTable extends PLF_MultipleSelectionElement {
// first element will be the key for the checkbox.
  ...
  function PLF_SingleTable($name, $label, $header, $values, $numRows, $required) {
  ...
  function render($tabIndex) {
    ...
    foreach ($this->values as $value) {
      ...
      $checkbox = '<input  '.$this->getDisabledAttribute().' type="radio" id="'.$labelFor.'" tabindex="'.$tabIndex.'" name="'.$this->getName().'[]" id="'.$this->getName().'" value="'.$key.'"';
